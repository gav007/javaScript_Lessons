# 00-button-lab · Button Lab

## Goal
Make buttons change text, count clicks, toggle a panel, and reset the page.

## Why this matters
This is the seed pattern for nearly every browser app: select an element, listen for an event, change the page.
