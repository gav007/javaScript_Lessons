# 08-todo-list-lite · Todo List Lite

## Goal
Add, complete, and delete tasks without local storage yet.

## Why this matters
This is the core pattern used in many apps: user changes data, you re-render the screen.
