# 07-card-filter-search · Card Filter Search

## Goal
Filter cards as the user types into a search box.

## Why this matters
Search/filter appears everywhere: shops, dashboards, admin panels, job boards, the lot.
