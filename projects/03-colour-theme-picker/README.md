# 03-colour-theme-picker · Colour Theme Picker

## Goal
Use a dropdown to change the look of the page.

## Why this matters
This teaches JavaScript controlling CSS without turning the codebase into soup.
