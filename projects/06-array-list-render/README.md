# 06-array-list-render · Array List Render

## Goal
Render a list of products/cards from an array of objects.

## Why this matters
Real web pages often render data, not hard-coded repeated HTML.
