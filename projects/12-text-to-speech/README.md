# 12-text-to-speech · Text To Speech

## Goal
Convert typed text into speech, with voice, pitch, and rate controls.

## Why this matters
This connects your own interface to real browser functionality. Tiny app, real API.
