# 01-counter-lab · Counter Lab

## Goal
Build a counter with +1, -1, +5, reset, and a simple limit warning.

## Why this matters
Counters teach state. State is data your app remembers while the page is open.
